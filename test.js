...
setInterval(()=>{
  ...
  const obj = CIMV2.query('SELECT DiskBytesPersec, DiskReadBytesPersec, DiskWriteBytesPersec, PercentDiskTime, PercentIdleTime FROM Win32_PerfFormattedData_PerfDisk_LogicalDisk WHERE Name="_Total"');
  console.log(obj);
